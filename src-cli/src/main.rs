...
fn main() {
        ...
        .subcommand(
            Command::new("init")
                ...
                .arg(
                    ...
                    │       ├── index.d.ts
                    │       ├── monitext.cjs.cjs
                    │       ├── monitext.cjs.min.bundle.cjs
                    │       ├── monitext.cjs.min.cjs
                    │       ├── monitext.esm.min.bundle.mjs
                    │       ├── monitext.esm.min.mjs
                    │       ├── monitext.esm.mjs
                    │       ├── monitext.iife.js
                    │       ├── monitext.iife.min.bundle.js
                    │       └── monitext.iife.min.js
                    ├── package.json
                    ├── package-lock.json
                    ├── readme.md
                    ├── src-cli
                    ...
                    33 directories, 85 files     .short('o')
                        .long("output")
                        .value_name("file")
    ...
    if let Some(init_args) = matches.subcommand_matches("init") {
        ...
        let content = format!(r#"import {{ createRuntime, getPolicyRecord }} from "monitext";
